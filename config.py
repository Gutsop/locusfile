...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6200049202:AAHqw3fa-qVlCy3NbVt85bv3WIgZhWYSrrY")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "25374144"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001575003822"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5821581983").split()):
        ADMINS.append(int(x))
except ValueError:
